    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <Link to={`/lecturer/modules/${quiz.module.id}/quizzes`} className="flex items-center text-gray-500 dark:text-gray-400 hover:text-primary-600">
            <ArrowLeft className="h-4 w-4 mr-1" /> Back to Quizzes
          </Link>
          <h1 className="text-2xl font-bold dark:text-white">Quiz Performance</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-500 dark:text-gray-400 text-sm font-medium">Total Attempts</span>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-500 dark:text-gray-400 text-sm font-medium">Average Score</span>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-500 dark:text-gray-400 text-sm font-medium">Quiz Title</span>
              <CheckCircle className="h-5 w-5 text-primary-500" />
            </div>
            <p className="text-lg font-bold text-gray-900 dark:text-white truncate">{quiz.title}</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 className="font-bold text-gray-900 dark:text-white">Student Results</h3>
          </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                {attempts.map((attempt) => {
                  ...
                  return (
                    <tr key={attempt.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                      ...
                      <td className="px-6 py-4">
                        {attempt.status === 'CANCELLED' ? (
                          <div className="flex flex-col">
                            <span className="px-2 py-1 rounded-full text-[10px] font-bold bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300 w-fit">
                              CANCELLED
                            </span>
                          ...
                          <span className="px-2 py-1 rounded-full text-[10px] font-bold bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 w-fit">
                            IN PROGRESS
                          </span>
                        ) : (
                          <span className={`px-2 py-1 rounded-full text-[10px] font-bold ${percentage >= 50 ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300'}`}>
