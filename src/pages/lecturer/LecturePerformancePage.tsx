      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">Analytics and insights into your teaching performance.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Avg Class Performance</p>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-purple-100 dark:border-purple-900 bg-gradient-to-br from-white to-purple-50 dark:from-gray-800 dark:to-purple-950 md:col-span-2">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-2">
                <Brain className="h-5 w-5 text-purple-600" />
                <p className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider">AI Student Risk Summary (Your Center)</p>
              </div>
              <div className="flex items-center text-[10px] font-bold text-purple-700 dark:text-purple-300 bg-purple-100 dark:bg-purple-900 px-2 py-0.5 rounded-full uppercase">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                ...
                <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase">High Risk</p>
              </div>
              <div className="text-center border-x border-purple-100 dark:border-purple-800">
                <p className="text-2xl font-bold text-yellow-600">{aiRiskStats?.mediumRisk || 0}</p>
                <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase">Medium Risk</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-green-600">{aiRiskStats?.lowRisk || 0}</p>
                <p className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase">Low Risk</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl border transition-all ${
                    selectedModule?.id === m.moduleId
                      ? 'bg-primary-50 dark:bg-primary-900 border-primary-200 dark:border-primary-700 ring-1 ring-primary-200 dark:ring-primary-700 shadow-sm'
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <h4 className="font-bold text-gray-900 dark:text-white line-clamp-1">{m.moduleName}</h4>
                    </div>
                    <ChevronRight className={`h-4 w-4 transition-transform ${selectedModule?.id === m.moduleId ? 'text-primary-600 translate-x-1' : 'text-gray-300 dark:text-gray-600'}`} />
                  </div>
                  <div className="mt-3 grid grid-cols-2 gap-2">
                    <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold">Marks: {m.avgMarks}%</div>
                    <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold">Att: {m.attendanceRate}%</div>
                  </div>
                </button>
              ))}
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            {moduleMetrics ? (
              <>
                <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Academic Chart */}
                    <div className="h-64">
                      <p className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-4 uppercase tracking-wider">Academic Performance</p>
                    ...
                    <div className="h-64">
                      <p className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-4 uppercase tracking-wider">Student Feedback</p>
                      <div className="flex flex-col items-center justify-center h-full">
                        <div className="relative h-40 w-40">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <span className="text-2xl font-black text-gray-900 dark:text-white">{moduleMetrics.metrics.feedback.avgRating}</span>
                            <span className="text-[10px] text-gray-500 dark:text-gray-400 font-bold">OUT OF 5</span>
                          </div>
                        </div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Based on {moduleMetrics.metrics.feedback.totalFeedbacks} responses</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-4">Content & Assignments</h4>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-400">Lecture Materials Shared</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-400">Assignments Created</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-400">Total Submissions Received</span>
                  ...
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center">
                    ...
                    <h4 className="font-bold text-gray-900 dark:text-white mb-1">Student Attendance</h4>
              ...
              <div className="bg-white dark:bg-gray-800 p-12 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 text-center flex flex-col items-center">
                <BarChart2 className="h-12 w-12 text-gray-300 dark:text-gray-600 mb-4" />
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Select a module to view analytics</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Detailed metrics for each module will appear here.</p>
              </div>
            )}
          </div>
        </div>
