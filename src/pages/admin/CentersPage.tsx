      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold dark:text-white">{stats.totalCenters}</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Lecturers</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">No centers found</p>
            </div>
          ) : (
            <>
                      ...
                      <tr key={center.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4">
                          <div className="grid grid-cols-4 gap-2 text-center">
                            ...
                            <div>
                              <p className="text-xs text-gray-600 dark:text-gray-400">Schedules</p>
