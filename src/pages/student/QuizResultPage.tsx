        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex items-center justify-between">
            <Link
              ...
              className="flex items-center text-gray-500 dark:text-gray-400 hover:text-primary-600"
            >
              <ArrowLeft className="h-4 w-4 mr-1" /> Back to Quizzes
            </Link>
            <h1 className="text-2xl font-bold dark:text-white">Results Pending</h1>
            <div className="w-10"></div>
          </div>

          <div className="bg-white dark:bg-gray-800 p-12 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm text-center space-y-6">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">{attempt.quiz.title}</h2>
              <p className="text-xl text-gray-600 dark:text-gray-400 font-medium">Your submission has been received!</p>
            </div>

            <div className="max-w-md mx-auto p-6 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
      ...
      <DashboardLayout>
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold dark:text-white">Attempt Cancelled</h1>
            <div className="w-10"></div>
          </div>

          <div className="bg-white dark:bg-gray-800 p-12 rounded-2xl border-2 border-red-100 dark:border-red-900 shadow-sm text-center space-y-6">
            ...
            <div className="max-w-md mx-auto p-6 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
              <p className="text-gray-700 dark:text-gray-300 font-medium mb-2">Reason for cancellation:</p>
    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-2xl font-bold dark:text-white">Quiz Results</h1>
          <div className="w-10"></div>
        </div>

        {/* Score Card */}
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm text-center space-y-4">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">{attempt.quiz.title}</h2>
          <div className="flex justify-center items-baseline space-x-2">
            <span className="text-5xl font-extrabold text-primary-600">{attempt.score}</span>
            <span className="text-2xl text-gray-400 dark:text-gray-500">/ {attempt.quiz.totalMarks}</span>
          </div>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold dark:text-white">Review Your Answers</h3>
          {attempt.answers.map((answer: any, index: number) => (
            <div key={answer.id} className={`p-6 rounded-xl border-2 bg-white dark:bg-gray-800 ${answer.isCorrect ? 'border-green-100 dark:border-green-900' : 'border-red-100 dark:border-red-900'}`}>
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <p className="font-bold text-gray-900 dark:text-white mb-4">{index + 1}. {answer.question.questionText}</p>
