          ...
          <div className="bg-white dark:bg-gray-800 px-6 py-5 max-h-[calc(100vh-200px)] overflow-y-auto">
            {loading ? (
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg border border-gray-100 dark:border-gray-700">
                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase">Total Students</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{data.stats.total}</p>
                  </div>
                      ...
                      <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {data.students.map((record: any) => (
                          <tr key={record.student.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-500 dark:text-gray-400">{record.student.studentCode}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
              ...
              <div className="text-center py-20">
                <p className="text-gray-500 dark:text-gray-400">No attendance data found.</p>
              </div>
            )}
          </div>
